...
\begin{itemize}[itemsep=2pt]
    ...
    \item \textbf{416 (\textit{Range Not Satisfiable})}: Menunjukkan bahwa \textit{server} menolak \textit{request} karena nilai rentang (\textit{range}) yang diminta dalam \textit{header} \texttt{Range} tidak dapat dipenuhi.
