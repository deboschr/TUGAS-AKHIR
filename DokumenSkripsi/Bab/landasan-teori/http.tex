...
Berikut adalah daftar kode status pada kategori ini:
\begin{itemize}[itemsep=1.5mm]
...
Kode-kode pada kelas ini menunjukkan bahwa telah terjadi kesalahan di sisi \textit{client}.
...
Kode-kode pada kelas ini menunjukkan bahwa \textit{server} menyadari bahwa terjadi kesalahan di sisi \textit{server}.
