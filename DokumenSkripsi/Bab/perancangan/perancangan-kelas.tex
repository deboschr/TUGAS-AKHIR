...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item \texttt{openNotificationWindow}: Metode ini digunakan untuk membuka jendela notifikasi. Masukan dari metode ini adalah jenis pesan dan teks pesan yang ingin ditampilkan pada jendela notifikasi.
    ...
    \vspace{8mm}
    % ######################################################################
    \item \textbf{Kelas \texttt{NotificationController}}\\
    ...
    \vspace{10mm}
    % ######################################################################
    \item \textbf{Kelas \texttt{HttpHandler}}\\
