...
\begin{enumerate}
    ...
    \begin{itemize}[itemsep=2pt]
        ...
        \item \texttt{INTERVAL}: Atribut ini nilai memiliki nilai yang bertipe \texttt{long} dan digunakan untuk mengatur jarak antarpermintaan HTTP.
        
        \item \texttt{lastRequestTime}: Atribut ini nilai memiliki nilai yang bertipe \texttt{long} dan digunakan untuk menyimpan waktu terakhir permintaan HTTP dilakukan.
