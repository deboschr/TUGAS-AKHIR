Perancangan antarmuka pengguna digunakan untuk memberikan gambaran visual komponen antarmuka yang tersedia pada aplikasi dekstop pemeriksa tautan rusak yang dikembangkan. Pada aplikasi ini akan buat dua jendala, yaitu jendela utama, dan jendela detail tautan. Berikut adalah penjelasan lebih detail untuk masing-masing jendela:

\begin{enumerate}
    \vspace{5mm}
    \item \textbf{Jendela Utama} \\
    Jendela utama merupakan merupakan antarmuka pengguna yang muncul ketika aplikasi baru dijalankan. Melalui jendela ini pengguna dapat memasukkan URL situs web yang menjadi target pemeriksaan, memulai dan menghentikan proses pemeriksaan, melihat daftar hasil pemeriksaan, melihat ringkasan hasil pemeriksaan, serta menyaring dan mengekspor hasil pemeriksaan. Rancangan jendela ini terdapat pada Gambar~\ref{fig:rancangan-antarmuka-jendela-utama}.
    ...
    \begin{enumerate}[itemsep=7pt]
        ...
        \item \textbf{All Links}: Menunjukan jumlah total tautan yang ditemukan.
        ...
        \begin{itemize}[itemsep=3pt]
            \item \textbf{\textit{Equals}}: Menampilkan tautan rusak dengan URL yang sama persis dengan kata kunci yang dimasukan.
            
            \item \textbf{\textit{Contains}}: Menampilkan tautan rusak dengan URL yang mengandung kata kunci yang dimasukan.
            
            \item \textbf{\textit{Starts With}}: Menampilkan tautan rusak dengan URL yang diawali dengan kata kunci yang dimasukan.
            
            \item \textbf{\textit{Ends With}}: Menampilkan tautan rusak dengan URL yang diakhiri dengan kata kunci yang dimasukan.
        \end{itemize}
        ...
        \begin{itemize}[itemsep=3pt]
            \item \textbf{\textit{Equals}}: Menampilkan tautan rusak dengan kode status sama persis dengan kata kunci yang dimasukan.
            
            \item \textbf{\textit{Greater Than}}: Menampilkan tautan rusak dengan kode status lebih besar dari kata kunci yang dimasukan.
            
            \item \textbf{\textit{Less Than}}: Menampilkan tautan rusak dengan kode status lebih kecil dari kata kunci yang dimasukan.
        \end{itemize}
        ...
        \item \textbf{Tabel Hasil}: Menampilkan daftar tautan rusak, tabel ini memiliki dua kolom sebagai berikut:
        \begin{enumerate}[itemsep=3pt]
            \item \textbf{Error}: Menunjukan pesan kesalahan tautan dari tautan rusak.
            \item \textbf{URL}: Menunjukan URL dari tautan rusak.
        \end{enumerate}
