...
\begin{enumerate}
    ...
    \begin{enumerate}[itemsep=7pt]
        ...
        \item \textbf{Tabel Hasil}: Digunakan untuk menampilkan untuk menampilkan daftar tautan rusak. Tabel ini memiliki dua kolom sebagai berikut:
