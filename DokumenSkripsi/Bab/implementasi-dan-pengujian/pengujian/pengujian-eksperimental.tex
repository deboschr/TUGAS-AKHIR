...
\begin{enumerate}
   ...
   Hasil pengujian pada situ web Informatika UNPAR ditampilkan pada Tabel~\ref{tab:hasil-pengujian-if-unpar}. 
   ...
   \begin{itemize}
      ...
      Pada kategori ini, hanya Broken Link Scanner yang menghasilkan I/O \textit{Error}, sedangkan Broken Link Checker dan Dead Link Checker mengategorikan tautan yang sama sebagai \textit{SSL Error}. URL pada tautan tersebut adalah \url{https://kiri.travel/}. Berdasarkan pemeriksaan manual, situs ini menunjukkan perilaku yang tidak stabil, terkadang menampilkan halaman keamanan, terkadang mengarahkan ke situs yang tidak relevan seperti halaman perjudian, dan pada waktu lain membuka halaman unduhan berkas.
   ...
   Hasil pengujian pada situ web Informatika UNPAR ditampilkan pada Tabel~\ref{tab:hasil-pengujian-if-unpad}.
   ...
   Hasil pengujian pada situ web Informatika UNPAR ditampilkan pada Tabel~\ref{tab:hasil-pengujian-if-unpas}. 
   ...
   Hasil pengujian pada situ web Informatika UNPAR ditampilkan pada Tabel~\ref{tab:hasil-pengujian-if-unikom}. 
