...
\begin{enumerate}
    ...
    Seluruh rancangan komponen antamuka jendela utama telah berhasil diimplementasi pada jendela ini. Pengguna dapat memasukkan URL situs web yang ingin diperiksa, memulai serta menghentikan proses pemeriksaan. Hasil pemeriksaan ditampilkan dalam bentuk tabel pada bagian \textit{Result} dengan ringkasannya yang ditampilkan pada bagian \textit{Summary}. Selain itu, pengguna juga dapat melakukan penyaringan terhadap hasil pemeriksaan.
