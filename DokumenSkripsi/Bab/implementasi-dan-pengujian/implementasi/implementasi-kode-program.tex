...
\begin{enumerate}[itemsep=2mm]
   ...
   \begin{enumerate}[itemsep=1mm]
      ...
      \item (Baris 7) Memasukkan tampilan antarmuka pengguna ke dalam jendela utama.
      ...
      \item (Baris 14--16) Jika terjadi \textit{exception}, maka tampilkan informasi \textit{error} ke konsol.
