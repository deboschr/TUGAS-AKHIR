...
Pada Subbab~\ref{subsec:0202-karakter-percent-encoding} dijelaskan bahwa URI memiliki aturan sintaks dan \textit{percent-encoding} yang harus dipenuhi agar dapat diproses dengan benar. Pelanggaran terhadap aturan ini menyebabkan URL tidak dapat ditafsirkan atau ditolak oleh server.
