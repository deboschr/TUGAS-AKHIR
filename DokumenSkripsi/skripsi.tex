...
\renewcommand{\vstaINA}{TUGAS AKHIR} \renewcommand{\vstaENG}{UNDERGRADUATE THESIS} 
...
\nottoggle{vbimbingan}{
	...
	\begin{center}
		...
		\includegraphics{000000-logo-unpar}\\\vspace{1cm}
...
\nottoggle{vsidangakhir}{	
	...
	\begin{flushright}	
		...
		\IfStrEq{\vttd}{digital}
		    ...
		    {\IfStrEq{\vttd}{gambar}
		        {\includegraphics[width=3.5cm,height=3.5cm,keepaspectratio]{000000-signature.png}\\}
