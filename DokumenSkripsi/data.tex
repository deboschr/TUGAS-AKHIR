...
\abstrakENG{Broken links on a website can disrupt information accessibility and diminish the overall user experience. To address this issue, this study develops a desktop-based application capable of detecting broken links on websites. The application performs web crawling by traversing each page within a website and extracting the hyperlinks found on those pages. Each link is then examined through an HTTP request to determine whether it remains accessible, and the results are presented in real time through a graphical user interface.
\\
