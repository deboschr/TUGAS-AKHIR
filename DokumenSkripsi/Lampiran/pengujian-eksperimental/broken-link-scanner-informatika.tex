...
\caption{Broken Link Scanner (informatika.unpar.ac.id)}
\vspace{-3mm}
\label{tab:bls-informatika} \\
\hline
...
\multicolumn{3}{c}{Tabel~\ref{tab:bls-informatika} dilanjutkan dari halaman sebelumnya}\\[4pt]
\hline
{\centering\arraybackslash\textbf{Kategori}} &
{\centering\arraybackslash\textbf{Error}} &
{\centering\arraybackslash\textbf{Jumlah}} \\ \hline
