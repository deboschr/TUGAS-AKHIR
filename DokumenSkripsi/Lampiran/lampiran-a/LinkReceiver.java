 ...
 *
 * Antarmuka ini digunakan sebagai mekanisme komunikasi (menerima/mengirim)
 * antara kelas yang melakukan proses pemeriksaan tautan (Crawler) dengan kelas
 * yang menerima dan mengolah hasilnya (MainController).
 */
