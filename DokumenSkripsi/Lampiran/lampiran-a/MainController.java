...
/**
 * Kelas ini bertugas untuk mengatur logika antarmuka pengguna, mengendalikan
 * interaksi pengguna, serta mengelola data yang ditampilkan pada jendela utama.
 */
public class MainController implements LinkReceiver {
   ...
   /**
    * Method initialize otomatis dipanggil JavaFX setelah semua elemen FXML selesai
    * dimuat.
    */
   @FXML
   ...
   public void receive(Link link) {
      /**
       * Karena crawling dijalankan bukan di thread JavaFX, maka di saat menambahkan
       * tautan hasil crawling ke variabel internal harus menggunakan runLater().
       */
   ...
   private void setTitleBar() {
      ...
      titleBar.setOnMousePressed((MouseEvent e) -> {
         // Ini penting biar pas drag, window nggak loncat ke posisi mouse, tapi tetap
         // konsisten dari titik klik awal
      ...
      titleBar.setOnMouseDragged((MouseEvent e) -> {
         // e.getScreenX() dan e.getScreenY() itu posisi mouse dalam koordinat layar
         // (global, terhadap monitor)
      ...
      maximizeBtn.setOnAction(e -> {
         // Fullscreen kalau sedang tidak fullscreen, dan tidak fullscreen kalau sedang
         // fullscreen
   ...
   /**
    * Method untuk mengatur prilaku tombol Start, Stop dan Export berdasarkan
    * status dari proses pemeriksaan.
    */
   ...
   /**
    * Method untuk mengatur konfigurasi TableView broken link, termasuk data,
    * perilaku baris, dan tampilan sel.
    */
   ...
   /**
    * Method untuk menerapkan filter pada daftar broken link berdasarkan kondisi
    * URL dan status code.
    */
      ...
      brokenLinks.setPredicate(link -> {
         ...
         if (scCond != null && !scCond.isBlank() && scText != null && !scText.isBlank()) {
            try {
               ...
               // Jika input bukan angka, abaikan filter status code dan anggap kondisi status
               // code lolos
               scOk = true;
            }
         }
   ...
   /**
    * Method untuk mengatur mekanisme pagination awal dan memastikan pagination
    * selalu diperbarui saat data broken link berubah.
    */
   private void setPagination() {
      // Panggil updatePagination pertama kali supaya tampilan tabel dan pagination
      // langsung sinkron saat GUI baru dibuka
      updatePagination();

      /**
       * Pasang listener ke daftar brokenLinks.
       * Setiap kali isi brokenLinks berubah (bertambah/berkurang), pagination akan
       * dihitung ulang.
       */
   ...
   /**
    * Method untuk menghitung ulang data pagination dan memperbarui tabel, tombol
    * pagination, serta informasi halaman.
    */
   private void updatePagination() {
      ...
      // Jika currentPage lebih besar dari totalPages (terjadi saat data berkurang),
      // sesuaikan currentPage ke halaman terakhir
   ...
   /**
    * Method untuk membuat dan menampilkan tombol-tombol pagination berdasarkan
   ...
   private void renderPaginationButtons() {
      ...
      // Jika jumlah halaman yang tampil masih kurang dari maksimal, geser startPage
      // ke kiri agar jumlah tombol tetap konsisten
