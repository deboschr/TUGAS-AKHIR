 ...
 * interaksi pengguna, serta mengelola data yang ditampilkan pada jendela
 * notifikasi.
 */
public class NotifController {
   ...
   /**
    * type dan message dikirim dari MainController melalui ControllerFactory di
    * Application.
    *
   ...
   /**
    * Method untuk mengatur isi dan tampilan notifikasi berdasarkan tipe
    * notifikasi.
    */
