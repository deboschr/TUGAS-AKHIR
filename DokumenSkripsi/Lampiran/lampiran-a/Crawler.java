...
public class Crawler {
   ...
   /**
    * Receiver dikirim oleh MainController, sebagai penerima link hasil
    * pemeriksaan.
    *
   ...
   public void start(String seedUrl) {
      ...
      /**
       * Loop selama belum dihentikan user, frontier belum kosong dan jumlah total
       * tautan belum melebihi batas
       */
      while (!isStopped && !frontier.isEmpty() && repositories.size() < MAX_LINKS) {
         ...
         for (var entry : linksOnWebpage.entrySet()) {
            ...
            if (UrlHandler.getHost(link.getUrl()).equalsIgnoreCase(rootHost)) {
               // Jika link adalah link internal, maka masukkan ke frontier antrean paling
               // belakang
               frontier.offer(link);
            } else {
    ...
    * @return Document HTML jika berhasil, null jika tidak berhasil atau tidak
    *         dibutuhkan
    */
   ...
   /**
    * Method biar MainController tahu apakah proses crawling dihentikan user atau
    * tidak.
    *
