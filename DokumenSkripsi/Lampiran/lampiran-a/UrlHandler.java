...
public class UrlHandler {
    ...
    * @return host dalam format ASCII (lowercase), atau string kosong jika tidak
    *         valid
    */
   public static String getHost(String url) {
      try {
         ...
         // Ubah host ke huruf kecil lalu konversi ke ASCII (in case domain internasional
         // / IDN)
         return IDN.toASCII(host.toLowerCase());
      } catch (IllegalArgumentException e) {
         // Jika URL tidak valid dan gagal diparse oleh URI, kembalikan string kosong
         // sebagai tanda gagal
         return "";
      }
   }
   ...
   public static String normalizeUrl(String rawUrl, boolean isStrict) {
      ...
      try {
         ...
         // Jika port adalah port default (80 untuk http, 443 untuk https), hapus port
         // dengan mengatur nilainya ke -1
         ...
         // Jika terjadi error parsing atau pembuatan URI, kembalikan URL asli agar tetap
