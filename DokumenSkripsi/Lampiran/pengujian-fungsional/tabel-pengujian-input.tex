...
|>{\raggedright\arraybackslash}p{4.5cm}
|>{\raggedright\arraybackslash}p{4.5cm}|}
\caption{Hasil Pengujian Funsional Input URL}
\vspace{-3mm}
\label{tab:pengujian-funsional-input-url} \\
...
\multicolumn{4}{c}{Tabel~\ref{tab:pengujian-funsional-input-url} dilanjutkan dari halaman sebelumnya}\\[4pt]
...
Jendela notifikasi \textit{warning} terbuka. &
Aplikasi menampilkan notifikasi \textit{warning} karena skema tidak terdeteksi. \\ \hline

3 &
Memasukkan URL tanpa host: \url{https:///fakultas} &
Jendela notifikasi \textit{warning} terbuka. &
Aplikasi menampilkan notifikasi \textit{warning} karena host tidak terdeteksi. \\ \hline

4 &
Memasukkan URL dengan skema selain http/https: \url{ftp://unpar.ac.id} &
Jendela notifikasi \textit{warning} terbuka. &
Aplikasi menampilkan notifikasi \textit{warning} karena skema bukan http/https. \\ \hline

5 &
Memasukkan URL dengan port non-default: \url{https://unpar.ac.id:8080} &
Input diterima dan proses pemeriksaan dimulai. &
Aplikasi mempertahankan port 8080 dan memulai pemeriksaan. \\ \hline
...
9 &
Memasukkan URL dengan sintaks tidak valid: \url{https//unpar.ac.id} &
Input diterima dan proses pemeriksaan dimulai. &
...
Jendela notifikasi \textit{warning} terbuka. &
Aplikasi menampilkan notifikasi \textit{warning} karena input kosong. \\ \hline
