...
|>{\raggedright\arraybackslash}p{4.5cm}
|>{\raggedright\arraybackslash}p{4.5cm}|}
\caption{Hasil pengujian fungsional pada tombol kontrol}
\vspace{-3mm}
...
2 &
Menekan tombol \textit{Start} ketika status aplikasi berada pada status \texttt{STOPPED} atau \texttt{COMPLETED}. &
