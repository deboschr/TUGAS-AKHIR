...
|>{\raggedright\arraybackslash}p{4.5cm}
|>{\raggedright\arraybackslash}p{4.5cm}|}
\caption{Hasil Pengujian Funsional Tombol}
\vspace{-3mm}
\label{tab:pengujian-funsional-tombol} \\
...
\multicolumn{4}{c}{Tabel~\ref{tab:pengujian-funsional-tombol} dilanjutkan dari halaman sebelumnya}\\[4pt]
