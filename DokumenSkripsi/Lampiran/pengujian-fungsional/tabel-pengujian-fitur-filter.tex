...
|>{\raggedright\arraybackslash}p{4.5cm}
|>{\raggedright\arraybackslash}p{4.5cm}|}
\caption{Hasil pengujian fungsional pada fitur \textit{filter}}
\vspace{-3mm}
\label{tab:hasil-pengujian-fungsional-fitur-filter} \\
...
\multicolumn{4}{c}{Tabel~\ref{tab:hasil-pengujian-fungsional-fitur-filter} dilanjutkan dari halaman sebelumnya}\\[4pt]
...
1 &
Menerapkan \textit{filter} URL dengan kondisi \textit{Equals} menggunakan sebuah URL tertentu (``https://godev.co/''). &
...
2 &
Menerapkan \textit{filter} URL dengan kondisi \textit{Contains} menggunakan kata kunci tertentu (``informatika'') &
...
3 &
Menerapkan \textit{filter} URL dengan kondisi \textit{Starts With} menggunakan awal URL tertentu (``https://informatika''). &
Tabel hanya menampilkan baris yang URL-nya diawali dengan kata kunci \textit{filter}. &
Tabel hanya menampilkan baris yang URL-nya dimulai dengan ``https://informatika''. \\ \hline

4 &
Menerapkan \textit{filter} URL dengan kondisi \textit{Ends With} menggunakan akhir URL tertentu (``.pdf''). &
...
5 &
Menerapkan \textit{filter} Kode Status dengan kondisi \textit{Equals} menggunakan sebuah nilai tertentu (0). &
Tabel hanya menampilkan baris yang kode statusnya sama dengan kunci \textit{filter}. &
Tabel hanya menampilkan baris dengan \textit{error} koneksi. \\ \hline

6 &
Menerapkan \textit{filter} Kode Status dengan kondisi \textit{Greater Than} menggunakan sebuah nilai tertentu (404). &
...
7 &
Menerapkan \textit{filter} Kode Status dengan kondisi \textit{Less Than} menggunakan sebuah nilai tertentu (404). &
...
8 &
Menerapkan \textit{filter} gabungan URL \textit{Contains} (``informatika'') dan Kode Status \textit{Equals} (404). &
