...
|>{\raggedright\arraybackslash}p{4.5cm}
|>{\raggedright\arraybackslash}p{4.5cm}|}
\caption{Hasil pengujian fungsional pada \textit{input seed} URL}
\vspace{-3mm}
\label{tab:hasil-pengujian-fungsional-input-seed-url} \\
...
\multicolumn{4}{c}{Tabel~\ref{tab:hasil-pengujian-fungsional-input-seed-url} dilanjutkan dari halaman sebelumnya}\\[4pt]
...
Jendela notifikasi \textit{warning} terbuka. &
Aplikasi menampilkan notifikasi \textit{warning} karena \textit{host} tidak terdeteksi. \\ \hline
...
\textit{Input} diterima dan proses pemeriksaan dimulai. &
Aplikasi gagal melakukan \textit{parsing} sebagai objek \texttt{URI}, mengembalikan URL awal, dan memulai proses pemeriksaan. \\ \hline
