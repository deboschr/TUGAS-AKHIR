...
|>{\raggedright\arraybackslash}p{4.5cm}
|>{\raggedright\arraybackslash}p{4.5cm}|}
\caption{Hasil pengujian fungsional pada jendela detail tautan}
\vspace{-3mm}
...
Jendela detail tautan terbuka dan menampilkan informasi lengkap sesuai baris yang ditekan. &
Saat baris ditekan, jendela detail muncul dan seluruh informasi (URL, \textit{final} URL, \textit{status code}, \textit{error}, dan sumber halaman) sesuai dengan data baris tersebut. \\ \hline
...
Jendela detail terbuka kembali dengan informasi yang benar sesuai tautan yang baru ditekan. &
