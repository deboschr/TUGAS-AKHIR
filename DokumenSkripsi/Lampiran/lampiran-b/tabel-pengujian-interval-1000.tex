...
\caption{(Pengujian 1) Percobaan \texttt{INTERVAL} 1000~milidetik}
\vspace{-3mm}
\label{tab:percobaan-interval-1000} \\
\hline
...
\multicolumn{3}{c}{Tabel~\ref{tab:percobaan-interval-1000} dilanjutkan dari halaman sebelumnya}\\[4pt]
...
{\centering\arraybackslash\textbf{27}} \\ \hline
