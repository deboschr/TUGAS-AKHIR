...
\caption{(Pengujian 3) Percobaan \texttt{REQUEST\_TIMEOUT} 10~detik}
\vspace{-3mm}
\label{tab:percobaan-request-timeout-10} \\
\hline
...
\multicolumn{3}{c}{Tabel~\ref{tab:percobaan-request-timeout-10} dilanjutkan dari halaman sebelumnya}\\[4pt]
\hline
{\centering\arraybackslash\textbf{Kategori}} &
{\centering\arraybackslash\textbf{Error}} &
{\centering\arraybackslash\textbf{Jumlah}} \\ \hline
