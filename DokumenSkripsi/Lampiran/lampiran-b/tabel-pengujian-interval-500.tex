...
\caption{(Pengujian 1) Percobaan \texttt{INTERVAL} 500~milidetik}
\vspace{-3mm}
\label{tab:percobaan-interval-500} \\
\hline
...
\multicolumn{3}{c}{Tabel~\ref{tab:percobaan-interval-500} dilanjutkan dari halaman sebelumnya}\\[4pt]
...
\multirow{5}{*}{\textbf{Connection Error}}
 ...
 & SSLHandshakeException & 6 \\ \hline

\multicolumn{2}{|c|}{{\centering\textbf{Total Connection Error}}} &
{\centering\arraybackslash\textbf{26}} \\ \hline
...
{\centering\arraybackslash\textbf{0}} \\ \hline
