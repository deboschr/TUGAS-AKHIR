...
\caption{(Pengujian 3) Percobaan \texttt{REQUEST\_TIMEOUT} 25~detik}
\vspace{-3mm}
\label{tab:percobaan-request-timeout-25} \\
\hline
...
\multicolumn{3}{c}{Tabel~\ref{tab:percobaan-request-timeout-25} dilanjutkan dari halaman sebelumnya}\\[4pt]
\hline
{\centering\arraybackslash\textbf{Kategori}} &
{\centering\arraybackslash\textbf{Error}} &
{\centering\arraybackslash\textbf{Jumlah}} \\ \hline
...
% ================= CONNECTION ERROR ======================
\multirow{4}{*}{\textbf{Connection Error}}
