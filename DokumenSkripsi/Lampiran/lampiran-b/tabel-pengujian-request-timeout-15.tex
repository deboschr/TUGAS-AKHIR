...
\caption{(Pengujian 3) Percobaan \texttt{REQUEST\_TIMEOUT} 15~detik}
\vspace{-3mm}
\label{tab:percobaan-request-timeout-15} \\
\hline
...
\multicolumn{3}{c}{Tabel~\ref{tab:percobaan-request-timeout-15} dilanjutkan dari halaman sebelumnya}\\[4pt]
\hline
{\centering\arraybackslash\textbf{Kategori}} &
{\centering\arraybackslash\textbf{Error}} &
{\centering\arraybackslash\textbf{Jumlah}} \\ \hline
...
\multirow{6}{*}{\textbf{Connection Error}}
 ...
 & HttpConnectTimeoutException & 4 \\ \cline{2-3}
