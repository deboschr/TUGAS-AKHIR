...
\caption{(Pengujian 2) Percobaan \texttt{CONNECTION\_TIMEOUT} 10~detik}
\vspace{-3mm}
\label{tab:percobaan-connection-timeout-10} \\
\hline
...
\multicolumn{3}{c}{Tabel~\ref{tab:percobaan-connection-timeout-10} dilanjutkan dari halaman sebelumnya}\\[4pt]
\hline
{\centering\arraybackslash\textbf{Kategori}} &
{\centering\arraybackslash\textbf{Error}} &
{\centering\arraybackslash\textbf{Jumlah}} \\ \hline
...
\multirow{6}{*}{\textbf{Connection Error}}
 ...
 & HttpTimeoutException & 2 \\ \cline{2-3}
