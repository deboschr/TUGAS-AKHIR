...
\caption{(Pengujian 2) Percobaan \texttt{CONNECTION\_TIMEOUT} 15~detik}
\vspace{-3mm}
\label{tab:percobaan-connection-timeout-15} \\
\hline
...
\multicolumn{3}{c}{Tabel~\ref{tab:percobaan-connection-timeout-15} dilanjutkan dari halaman sebelumnya}\\[4pt]
\hline
{\centering\arraybackslash\textbf{Kategori}} &
{\centering\arraybackslash\textbf{Error}} &
{\centering\arraybackslash\textbf{Jumlah}} \\ \hline
