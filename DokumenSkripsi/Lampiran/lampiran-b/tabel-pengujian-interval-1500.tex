...
\caption{(Pengujian 1) Percobaan \texttt{INTERVAL} 1500~milidetik}
\vspace{-3mm}
\label{tab:percobaan-interval-1500} \\
\hline
...
\multicolumn{3}{c}{Tabel~\ref{tab:percobaan-interval-1500} dilanjutkan dari halaman sebelumnya}\\[4pt]
