...
\caption{(Pengujian 3) Percobaan Request Timeout 18~detik}
\vspace{-3mm}
\label{tab:percobaan-request-timeout-18} \\
\hline
...
\multicolumn{3}{c}{Tabel~\ref{tab:percobaan-request-timeout-18} dilanjutkan dari halaman sebelumnya}\\[4pt]
\hline
{\centering\arraybackslash\textbf{Kategori}} &
{\centering\arraybackslash\textbf{Error}} &
{\centering\arraybackslash\textbf{Jumlah}} \\ \hline
