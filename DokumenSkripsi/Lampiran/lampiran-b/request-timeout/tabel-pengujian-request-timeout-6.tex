...
\caption{(Pengujian 3) Percobaan Request Timeout 6~detik}
\vspace{-3mm}
\label{tab:percobaan-request-timeout-6} \\
\hline
...
\multicolumn{3}{c}{Tabel~\ref{tab:percobaan-request-timeout-6} dilanjutkan dari halaman sebelumnya}\\[4pt]
\hline
{\centering\arraybackslash\textbf{Kategori}} &
{\centering\arraybackslash\textbf{Error}} &
{\centering\arraybackslash\textbf{Jumlah}} \\ \hline
...
\multirow{6}{*}{\textbf{Connection Error}}
 & ConnectException & 9 \\ \cline{2-3}
 & HttpConnectTimeoutException & 8 \\ \cline{2-3}
 & HttpTimeoutException & 81 \\ \cline{2-3}
