...
\caption{(Pengujian 3) Percobaan Request Timeout 7~detik}
\vspace{-3mm}
\label{tab:percobaan-request-timeout-7} \\
\hline
...
\multicolumn{3}{c}{Tabel~\ref{tab:percobaan-request-timeout-7} dilanjutkan dari halaman sebelumnya}\\[4pt]
\hline
{\centering\arraybackslash\textbf{Kategori}} &
{\centering\arraybackslash\textbf{Error}} &
{\centering\arraybackslash\textbf{Jumlah}} \\ \hline
...
\multirow{1}{*}{\textbf{5XX Server Error}}
 & 500 Internal Server Error & 3 \\ \hline
