...
\caption{(Pengujian 3) Percobaan Request Timeout 8~detik}
\vspace{-3mm}
\label{tab:percobaan-request-timeout-8} \\
\hline
...
\multicolumn{3}{c}{Tabel~\ref{tab:percobaan-request-timeout-8} dilanjutkan dari halaman sebelumnya}\\[4pt]
\hline
{\centering\arraybackslash\textbf{Kategori}} &
{\centering\arraybackslash\textbf{Error}} &
{\centering\arraybackslash\textbf{Jumlah}} \\ \hline
...
\multirow{6}{*}{\textbf{Connection Error}}
 ...
 & HttpConnectTimeoutException & 3 \\ \cline{2-3}
