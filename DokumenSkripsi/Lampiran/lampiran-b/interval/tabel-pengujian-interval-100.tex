...
\caption{(Pengujian 1) Percobaan Interval 100~milidetik}
\vspace{-3mm}
\label{tab:percobaan-interval-100} \\
\hline
...
\multicolumn{3}{c}{Tabel~\ref{tab:percobaan-interval-100} dilanjutkan dari halaman sebelumnya}\\[4pt]
...
\multirow{6}{*}{\textbf{Connection Error}}
 ...
 & HttpTimeoutException & 1 \\ \cline{2-3}
...
{\centering\arraybackslash\textbf{41}} \\ \hline
