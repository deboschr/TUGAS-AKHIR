...
\caption{(Pengujian 1) Percobaan Interval 400~milidetik}
\vspace{-3mm}
\label{tab:percobaan-interval-400} \\
\hline
...
\multicolumn{3}{c}{Tabel~\ref{tab:percobaan-interval-400} dilanjutkan dari halaman sebelumnya}\\[4pt]
