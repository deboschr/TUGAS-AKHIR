...
\caption{(Pengujian 1) Percobaan Interval 700~milidetik}
\vspace{-3mm}
\label{tab:percobaan-interval-700} \\
\hline
...
\multicolumn{3}{c}{Tabel~\ref{tab:percobaan-interval-700} dilanjutkan dari halaman sebelumnya}\\[4pt]
