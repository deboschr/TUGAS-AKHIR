...
\caption{(Pengujian 1) Percobaan Interval 1100~milidetik}
\vspace{-3mm}
\label{tab:percobaan-interval-1100} \\
\hline
...
\multicolumn{3}{c}{Tabel~\ref{tab:percobaan-interval-1100} dilanjutkan dari halaman sebelumnya}\\[4pt]
...
{\centering\arraybackslash\textbf{32}} \\ \hline
