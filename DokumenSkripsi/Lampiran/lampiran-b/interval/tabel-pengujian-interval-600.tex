...
\caption{(Pengujian 1) Percobaan Interval 600~milidetik}
\vspace{-3mm}
\label{tab:percobaan-interval-600} \\
\hline
...
\multicolumn{3}{c}{Tabel~\ref{tab:percobaan-interval-600} dilanjutkan dari halaman sebelumnya}\\[4pt]
...
{\centering\arraybackslash\textbf{43}} \\ \hline
