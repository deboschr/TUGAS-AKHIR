...
\caption{(Pengujian 1) Percobaan Interval 300~milidetik}
\vspace{-3mm}
\label{tab:percobaan-interval-300} \\
\hline
...
\multicolumn{3}{c}{Tabel~\ref{tab:percobaan-interval-300} dilanjutkan dari halaman sebelumnya}\\[4pt]
