...
\caption{(Pengujian 1) Percobaan Interval 800~milidetik}
\vspace{-3mm}
\label{tab:percobaan-interval-800} \\
\hline
...
\multicolumn{3}{c}{Tabel~\ref{tab:percobaan-interval-800} dilanjutkan dari halaman sebelumnya}\\[4pt]
...
{\centering\arraybackslash\textbf{40}} \\ \hline
