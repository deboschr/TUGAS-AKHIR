...
\caption{(Pengujian 1) Percobaan Interval 900~milidetik}
\vspace{-3mm}
\label{tab:percobaan-interval-900} \\
\hline
...
\multicolumn{3}{c}{Tabel~\ref{tab:percobaan-interval-900} dilanjutkan dari halaman sebelumnya}\\[4pt]
...
\multirow{6}{*}{\textbf{Connection Error}}
 ...
 & HttpConnectTimeoutException & 7 \\ \cline{2-3}
...
{\centering\arraybackslash\textbf{31}} \\ \hline
...
\multirow{5}{*}{\textbf{4XX Client Error}}
 ...
 & 429 Too Many Requests & 5 \\ \hline

\multicolumn{2}{|c|}{\centering\textbf{Total 4XX Client Error}} &
{\centering\arraybackslash\textbf{42}} \\ \hline
