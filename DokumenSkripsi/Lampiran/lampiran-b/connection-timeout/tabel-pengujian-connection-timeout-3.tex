...
\caption{(Pengujian 2) Percobaan Connection Timeout 3~detik}
\vspace{-3mm}
\label{tab:percobaan-connection-timeout-3} \\
\hline
...
\multicolumn{3}{c}{Tabel~\ref{tab:percobaan-connection-timeout-3} dilanjutkan dari halaman sebelumnya}\\[4pt]
\hline
{\centering\arraybackslash\textbf{Kategori}} &
{\centering\arraybackslash\textbf{Error}} &
{\centering\arraybackslash\textbf{Jumlah}} \\ \hline
...
\multirow{6}{*}{\textbf{Connection Error}}
 ...
 & HttpConnectTimeoutException & 11 \\ \cline{2-3}
